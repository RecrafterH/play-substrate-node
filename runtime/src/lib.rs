...
use frame_system::{
	EnsureSigned, EnsureRoot, EnsureSignedBy,
};
use sp_std::prelude::*;
#[cfg(feature = "std")]
...
/// Configure the pallet-test-staking in pallets/test-staking.
impl pallet_test_staking::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
}
...
construct_runtime!(
	pub struct Runtime {
		...
		TestStaking: pallet_test_staking,
